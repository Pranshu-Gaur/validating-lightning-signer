...
use lightning::ln::chan_utils::{
    ...
    CounterpartyChannelTransactionParameters, HolderCommitmentTransaction, HTLCOutputInCommitment,
...
use crate::tx::tx::{
    build_commitment_tx, CommitmentInfo2, get_commitment_transaction_number_obscure_factor,
    HTLCInfo, HTLCInfo2,
};
